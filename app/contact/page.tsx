...
function Contact() {
  return (
    <section className="md:max-w-7xl md:mx-auto px-10 md:px-12 lg:px-20 py-4 md:py-8 lg:py-12 xl:py-16">
      <div className="flex flex-col text-left">
        <div className="space-y-4 lg:space-y-6">
          <h1 className="font-serif font-bold text-[#1A2B4C] text-5xl md:text-5xl lg:text-6xl xl:text-7xl">Get in Touch</h1>
