...
function Button({type, label, padding_x = "px-8", padding_y = "py-4", large = false, icon,}: ButtonProps) {
    ...
    return (
        ...
        type={type}
        className={`text-[#1A2B4C] bg-[#FFC107]/40 noise-bg bg-opacity-100 filter brightness-110 font-semibold rounded-full mb-15 hover:bg-[#FFC107] transition text-base 
