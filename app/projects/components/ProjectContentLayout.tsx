...
function ProjContentLayout({children}: ProjContentLayoutProps) {
    return ( 
        <>   
            <div className="glass-container flex flex-col w-full justify-start px-6 py-6 md:px-10 md:py-10 lg:px-15 lg:py-15 xl:px-20 xl:py-20 bg-[#f5f5f5] rounded-xl" style={{ boxShadow: '0px 0px 5px 0px rgba(0, 0, 0, 0.25)' }}>
                {children}
            </div>
